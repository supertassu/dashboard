<template>
    <tile :position="position">
        <div class="flex flex-col h-full" :class="{ 'justify-between': sleep > 0, 'justify-center': ! sleep > 0 }">
            <div v-if="sleep > 0" class="text-gray-200">
                Health information
            </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            axios.get(window.baseUrl + '/initial/fitness')
                .then(({data}) => {
                    this.loaded = true;
